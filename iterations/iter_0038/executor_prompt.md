...
- iteration_dir: /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0038
...
2. Write iteration artifacts directly inside:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0038
3. Required files to write:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0038/executor_iteration_report.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0038/executor_next_steps.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0038/executor_hypothesis_screen.json
...
- iter_0030 H73 | family=module_structure | decision=neutral | direction=mixed | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0030 H74 | family=cross_model_alignment | decision=negative | direction=mixed | method=Seed42 held-out-domain pilot on immune/lung/external_lung with source/target-disjoint spli
- iter_0030 H75 | family=manifold_distance | decision=inconclusive | direction=mixed | method=Seed42 screen across immune/lung/external_lung and source/target-disjoint splits using lay
Suggested retirement candidates by repeated negatives/inconclusive: cross_model_alignment, graph_topology, manifold_distance, module_structure, topology_stability

Brainstormer guidance from previous iteration (must be addressed):
Wrote the requested one-pass brainstormer outputs for `iter_0037`:

- `iterations/iter_0037/brainstormer_structured_feedback.md`
- `iterations/iter_0037/brainstormer_hypothesis_roadmap.md`
- `iterations/iter_0037/brainstormer_next_iteration_brief.md`

Also updated tracking per project rule:

- `tracking/prompt.md`

Concise outcome summary:
- Stale directions were triaged with explicit `retire_now` vs `rescue_once_with_major_change`.
- A fresh 15-idea hypothesis portfolio (`N478`-`N492`) was produced with hypothesis, test, expected signal, controls, value, and cost.
- Top 3 execution picks selected:
1. `N482` high-probability discovery (calibrated `H95` rescue),
2. `N487` high-risk/high-reward (cross-model role-graph alignment),
3. `N486` cheap broad-screen (ID heterogeneity entropy).
