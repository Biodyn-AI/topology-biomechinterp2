...
- iteration_dir: /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0021
...
2. Write iteration artifacts directly inside:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0021
3. Required files to write:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0021/executor_iteration_report.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0021/executor_next_steps.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0021/executor_hypothesis_screen.json
...
Suggested retirement candidates by repeated negatives/inconclusive: cross_model_alignment, graph_topology, intrinsic_dimensionality, topology_stability

Brainstormer guidance from previous iteration (must be addressed):
Completed one brainstorming pass for `iter_0020` and wrote the requested files:

- `iterations/iter_0020/brainstormer_structured_feedback.md`
- `iterations/iter_0020/brainstormer_hypothesis_roadmap.md`
- `iterations/iter_0020/brainstormer_next_iteration_brief.md`
...
Concise outcome:
- Gate status handled: `passed_min_research_gate=true`.
- Stale directions explicitly triaged into `retire_now` and `rescue_once_with_major_change`.
- Fresh portfolio delivered with 14 testable hypotheses (`N198`-`N211`) spanning topology, manifold geometry, cross-model transfer, biological anchoring, and mechanistic motifs.
- Top 3 immediate execution picks set to:
  1. `N198` (high-probability discovery)
  2. `N200` (high-risk/high-reward)
  3. `N208` (cheap broad-screen)
