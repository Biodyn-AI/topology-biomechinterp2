...
- iteration_dir: /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0039
...
2. Write iteration artifacts directly inside:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0039
3. Required files to write:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0039/executor_iteration_report.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0039/executor_next_steps.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0039/executor_hypothesis_screen.json
...
- iter_0038 H97 | family=graph_topology | decision=negative | direction=mixed | method=Seed42 breadth run across immune/lung/external_lung with source/target-disjoint splits and
- iter_0038 H98 | family=intrinsic_dimensionality | decision=negative | direction=negative | method=Seed42 breadth run across immune/lung/external_lung with source/target-disjoint splits and
- iter_0038 H99 | family=cross_model_alignment | decision=negative | direction=mixed | method=Seed42 pilot across immune/lung/external_lung and layers {7,11}; built GO-module role vect
- iter_0037 H94 | family=persistent_homology | decision=negative | direction=negative | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0037 H95 | family=graph_topology | decision=inconclusive | direction=mixed | method=Seed42 breadth run across immune/lung/external_lung with source/target-disjoint splits and
- iter_0037 H96 | family=cross_model_alignment | decision=negative | direction=negative | method=Seed42 pilot across immune/lung/external_lung and layers {7,11}; computed module-level top
- iter_0036 H91 | family=split_robustness | decision=promising | direction=positive | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0036 H92 | family=topology_stability | decision=negative | direction=negative | method=Seed42 breadth screen across immune/lung/external_lung, source/target-disjoint splits, and
- iter_0036 H93 | family=persistent_homology | decision=promising | direction=positive | method=Seed42 breadth run across immune/lung/external_lung, source/target-disjoint splits, and la
- iter_0035 H88 | family=split_robustness | decision=promising | direction=positive | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0035 H89 | family=intrinsic_dimensionality | decision=negative | direction=mixed | method=Seed42 breadth screen across immune/lung/external_lung, source/target-disjoint splits, and
- iter_0035 H90 | family=topology_stability | decision=negative | direction=mixed | method=Seed42 breadth screen across immune/lung/external_lung, source/target-disjoint splits, and
- iter_0034 H85 | family=persistent_homology | decision=neutral | direction=mixed | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0034 H86 | family=cross_model_alignment | decision=negative | direction=negative | method=Seed42 pilot on immune/lung/external_lung with scGPT layers {0,3,7,11} and Geneformer toke
- iter_0034 H87 | family=manifold_distance | decision=promising | direction=positive | method=Seed42 breadth screen across immune/lung/external_lung, source/target-disjoint splits, and
- iter_0033 H82 | family=persistent_homology | decision=promising | direction=positive | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0033 H83 | family=cross_model_alignment | decision=negative | direction=negative | method=Seed42 pilot on immune/lung/external_lung with scGPT layers {0,3,7,11} and Geneformer toke
- iter_0033 H84 | family=graph_topology | decision=negative | direction=negative | method=Seed42 breadth screen across immune/lung/external_lung, source/target-disjoint splits, and
- iter_0032 H79 | family=module_structure | decision=inconclusive | direction=mixed | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0032 H80 | family=cross_model_alignment | decision=negative | direction=negative | method=Seed42 pilot across immune/lung/external_lung and layers {7,11}; construct TRRUST+GO pathw
- iter_0032 H81 | family=manifold_distance | decision=negative | direction=negative | method=Seed42 screen across immune/lung/external_lung, source/target-disjoint splits, and layers 
- iter_0031 H76 | family=module_structure | decision=inconclusive | direction=mixed | method=Across immune/lung/external_lung with seeds 42/43/44, source/target-disjoint splits, and l
- iter_0031 H77 | family=cross_model_alignment | decision=negative | direction=negative | method=Seed42 held-out-domain pilot on immune/lung/external_lung with source/target-disjoint spli
- iter_0031 H78 | family=manifold_distance | decision=inconclusive | direction=mixed | method=Seed42 screen across immune/lung/external_lung and source/target-disjoint splits using lay
Suggested retirement candidates by repeated negatives/inconclusive: cross_model_alignment, graph_topology, intrinsic_dimensionality, manifold_distance, module_structure, topology_stability

Brainstormer guidance from previous iteration (must be addressed):
Completed one brainstorming pass for `iter_0038` and wrote all requested outputs:

- `iterations/iter_0038/brainstormer_structured_feedback.md`
- `iterations/iter_0038/brainstormer_hypothesis_roadmap.md`
- `iterations/iter_0038/brainstormer_next_iteration_brief.md`

Key results:
- Explicit stale-direction triage with `retire_now` / `rescue_once_with_major_change`.
- New 15-idea hypothesis portfolio (`N493`-`N507`) with test design, expected signal, controls, value, and cost.
- Top 3 execution picks:
  1. `N493` (high-probability discovery),
  2. `N501` (high-risk/high-reward),
  3. `N497` (cheap broad-screen).
- Updated `tracking/prompt.md` with the required `Brainstormer Update (iter_0038)` status block.

Hard stop respected: single brainstorming cycle only.
