...
- iteration_dir: /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0040
...
2. Write iteration artifacts directly inside:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0040
3. Required files to write:
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0040/executor_iteration_report.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0040/executor_next_steps.md
   - /Volumes/Crucial X6/MacBook/biomechinterp/biodyn-work/subproject_40_topology_hypothesis_screening_autoloop/iterations/iter_0040/executor_hypothesis_screen.json
...
Suggested retirement candidates by repeated negatives/inconclusive: cross_model_alignment, graph_topology, intrinsic_dimensionality, persistent_homology, topology_stability

Brainstormer guidance from previous iteration (must be addressed):
Completed one brainstorming pass for `iter_0039` and wrote all requested outputs:

- `iterations/iter_0039/brainstormer_structured_feedback.md`
- `iterations/iter_0039/brainstormer_hypothesis_roadmap.md`
- `iterations/iter_0039/brainstormer_next_iteration_brief.md`

What’s inside:

- Explicit stale-direction triage (`retire_now` vs `rescue_once_with_major_change`), including:
  - cross-model unsupervised concordance/OT-depth lineage retired (`11` consecutive negatives),
  - exact `H100` retired,
  - additive `H101` marked `rescue_once_with_major_change` only.
- New hypothesis portfolio with 15 ideas (`N508`–`N522`) covering:
  - topology/PH variants,
  - manifold geometry,
  - cross-model transfer/alignment,
  - biological anchoring (TRRUST/GO/STRING/Cell Ontology),
  - algorithmic/mechanistic motifs.
- Top 3 immediate candidates selected:
  1. `N508` high-probability discovery,
  2. `N515` high-risk/high-reward,
  3. `N520` cheap broad-screen.
- Concrete next-iteration execution brief with gates, null budgets, fail-fast rules, and contingency if gate fails.

Also updated project tracking at `tracking/prompt.md` with a new `Brainstormer Update (iter_0039)` block.
